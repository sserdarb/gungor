...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "services.sub":      { tr: "25 hizmet kalemiyle yapılarınızı içten dışa koruma altına alıyoruz.", en: "We protect your structures inside and out with 25 service items." },
  "services.cat1":     { tr: "Su Yalıtım Sistemleri", en: "Waterproofing Systems" },
  "services.cat2":     { tr: "Endüstriyel Zemin Kaplamaları", en: "Industrial Floor Coatings" },
  "services.cat3":     { tr: "Dekoratif Sistemler", en: "Decorative Systems" },
  "services.cat1Count":{ tr: "9 Hizmet", en: "9 Services" },
  "services.cat2Count":{ tr: "6 Hizmet", en: "6 Services" },
  "services.cat3Count":{ tr: "10 Hizmet", en: "10 Services" },
